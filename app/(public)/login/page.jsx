...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 flex justify-center px-4 py-10 mt-10">
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-xl bg-white/20 border ${errors.emailId
                      ? "border-red-400"
                      : "border-white/20"
                    } px-5 py-2 text-white placeholder:text-white/60 outline-none focus:ring-2 focus:ring-white transition text-lg`}
                  {...register("emailId")}
                />

                {errors.emailId && (
                  <p className="text-red-500 mt-2 text-md">
              ...
              <button type="submit" disabled={loading} className="w-full h-14 rounded-xl bg-white text-purple-700 font-bold text-xl transition-all duration-300 disabled:opacity-70 disabled:scale-100 cursor-pointer">
                {loading ? (
